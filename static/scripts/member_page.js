...
let imgFileBtn = document.querySelector(".img-file");
let uploadBtn = document.querySelector(".upload-pc-btn");
let messsage = document.querySelector(".message");
let penBtn = document.querySelector(".pen-btn");
let changeNameBtn = document.querySelector(".change-name-btn");
let changeEmailBtn = document.querySelector(".change-email-btn");
let okNameBtn = document.querySelector(".ok-name-btn");
let okEmailBtn =  document.querySelector(".ok-email-btn");
let errorMsg = document.querySelector(".update-error-msg");
let cancelImgBtn = document.querySelector(".cancel-img-btn");
let originSrc;
let pcChange = false;
